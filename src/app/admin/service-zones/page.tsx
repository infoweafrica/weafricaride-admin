  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold text-gray-900 capitalize">service zones</h1><p className="text-gray-500 mt-1">Manage service zones</p></div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        <p className="text-gray-500 font-medium capitalize">service zones Module</p>
